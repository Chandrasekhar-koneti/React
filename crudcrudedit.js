...
document.getElementById('my-form').addEventListener('submit', function (e) {
  ...
  axios.post('https://crudcrud.com/api/f7b927208b1a4726a798426584dda07f/appointmentdata',userDetail)
        .then((response) => {
...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    axios.get("https://crudcrud.com/api/f7b927208b1a4726a798426584dda07f/appointmentdata")
        .then((response) => {
            console.log(response);
...
function editUserDetails( name, emailId,user_id){
 ...
 function deleteUser(user_id){
    ...
    axios.delete(`https://crudcrud.com/api/f7b927208b1a4726a798426584dda07f/appointmentdata/${user_id}`)
